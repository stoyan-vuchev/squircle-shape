...
package squircleshape.application.shared.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/squircleshape.application.shared.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/squircleshape.application.shared.generated.resources/" +
      path)
